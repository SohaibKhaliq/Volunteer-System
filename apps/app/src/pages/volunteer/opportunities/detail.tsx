...
export default function OpportunityDetail() {
  ...
  const { data: opportunity, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await axios.get(`/volunteer/opportunities/${id}`);
      return res;
    },
    enabled: !!id
  });
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {format(new Date(opportunity.startAt), 'p')} -{' '}
                      {opportunity.endAt ? format(new Date(opportunity.endAt), 'p') : 'End of day'}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{opportunity.location || 'Online / Remote'}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <Dialog open={isApplyOpen} onOpenChange={setIsApplyOpen}>
                    ...
                    <DialogContent>
                      ...
                      <DialogFooter>
                        ...
                        <Button
                          onClick={() => applyMutation.mutate({ notes: applyNotes })}
