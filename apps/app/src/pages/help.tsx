...
const MOCK_REQUESTS = [
  {
    ...
    urgency: 'High',
    date: '2 hours ago',
    description: 'Families in remote villages need warm clothes for the upcoming winter.',
    status: 'Open'
  },
  {
    id: 2,
    ...
    urgency: 'Medium',
    date: '5 hours ago',
    description: 'Need 5 volunteers to help distribute food packages this weekend.',
    status: 'Open'
  },
  {
    id: 3,
    ...
    urgency: 'Critical',
    date: '1 day ago',
    description: 'Urgent transport needed for medical supplies to field hospital.',
    status: 'In Progress'
  }
];
